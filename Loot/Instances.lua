...
AtlasLoot_Data["AtlasLootItems"] = {
	...
	MCRagnaros = { --https://database.turtle-wow.org/?npc=11502
		...
		{ 0, "", "", "" },
		{ 17204, "INV_Misc_Gem_Pearl_05", "=q5=Eye of Sulfuras", "=q1=#31#", "6%" },
		{ 17182, "INV_Hammer_Unique_Sulfuras", "=q5=Sulfuras, Hand of Ragnaros", "=ds=#h2#, #w6#" },
		{ 0, "", "", "" },
	...
	MCTrashMobs = {
		...
		{ 17011, "Spell_Nature_Earthquake", "=q3=Lava Core", "=ds=#m23#", "15%" },
		{ 17010, "Spell_Fire_FlameBolt", "=q3=Fiery Core", "=ds=#m26#", "35%" },
		{ 11382, "INV_Misc_Gem_Bloodstone_03", "=q2=Blood of the Mountain", "=ds=#m26# =q7=#x63#", "0.02%" },
