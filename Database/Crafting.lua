AtlasLoot_Data["AtlasLootCrafting"] = {
	...
	SmithingJourneyman1 = {
		...
		{ "s34762", "ceremonial_belt_buckle_1", "=q2=Ceremonial Belt Buckle", "=ds=#sr# =so1=125 =so2=145 =so3=160 =so4=175" },
	...
	SmithingExpert1 = {
		{ "s65210", "INV_Sword_10", "=q2=Simple Bronze Katana", "=ds=#sr# =so1=155 =so2=175 =so3=190 =so4=205" },
	...
	SmithingArtisan4 = {
		...
		{ "s36948", "INV_Shield_21", "=q4=Bulwark of Unshaken Earth", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	},
	Armorsmith1 = {
	...
	LeatherJourneyman1 = {
		...
		{ "s34760", "INV_Bracer_09", "=q3=Grimtotem Bracers", "=ds=#sr# =so1=125 =so2=145 =so3=160 =so4=175" },
	...
	TailoringJourneyman1 = {
		...
		{ "s7636", "INV_Chest_Cloth_22", "=q2=Green Woolen Robe", "=ds=#sr# =so1=90 =so2=115 =so3=132 =so4=150" },
	...
	TailoringExpert1 = {
		...
		{ "s83", "inv_gauntlets_09", "=q3=Stormreaver Gloves", "=ds=#sr# =so1=185 =so2=185 =so3=200 =so4=215" },
	...
	TailoringArtisan5 = {
		...
		{ "s36915", "inv_misc_cape_02", "=q4=Spellwoven Nobility Drape", "=ds=#sr# =so1=300 =so2=315 =so3=322 =so4=330" },
	},
	TailoringHelm1 = {
		{ "s8760", "inv_helmet_29", "=q2=Azure Silk Hood", "=ds=#sr# =so1=145 =so2=155 =so3=160 =so4=165" },
		{ "s3857", "inv_helmet_31", "=q2=Enchanter's Cowl", "=ds=#sr# =so1=165 =so2=185 =so3=200 =so4=215" },
	...
	EngineeringArtisan2 = {
		...
		{ "s36946", "INV_Misc_Spyglass_02", "=q3=Facetted Crystal Scope", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		{ "s32310", "inv_ammo_bullet_03", "=q3=Enchanted Thorium Shells", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	},
	...
	--------------
	SurvivalApprentice1 = {
		{ "s46064", "INV_Torch_Lit", "=q1=Dim Torch", "=ds=#sr# =so1=1 =so2=10 =so3=12 =so4=15" },
		{ "s36765", "bundle_of_simple_sticks_1", "=q1=Bundle of Simple Sticks", "=ds=#sr# =so1=5 =so2=10 =so3=12 =so4=15" },
		...
		{ "s36768", "INV_Axe_14", "=q1=Crude Hatchet", "=ds=#sr# =so1=15 =so2=25 =so3=35 =so4=45" },
		{ "s36766", "INV_Staff_08", "=q1=Crude Walking Stick", "=ds=#sr# =so1=15 =so2=25 =so3=35 =so4=45" },
		{ "s36767", "INV_Sword_16", "=q1=Crude Machete", "=ds=#sr# =so1=15 =so2=25 =so3=35 =so4=45" },
		{ "s36769", "INV_Weapon_Bow_02", "=q1=Crude Hunting Bow", "=ds=#sr# =so1=15 =so2=25 =so3=35 =so4=45" },
		{ "s36770", "INV_Misc_Lantern_01", "=q2=Copper Lantern", "=ds=#sr# =so1=20 =so2=40 =so3=50 =so4=60" },
		{ "s36771", "seed_shooter_2", "=q1=Simple Slingshot", "=ds=#sr# =so1=30 =so2=50 =so3=60 =so4=70" },
		{ "s36772", "simple_herbalists_backpack_2", "=q1=Simple Herbalist's Backpack", "=ds=#sr# =so1=40 =so2=60 =so3=70 =so4=80" },
		{ "s36773", "INV_Misc_Bag_02", "=q1=Makeshift Ration Bag", "=ds=#sr# =so1=40 =so2=60 =so3=70 =so4=80" },
		{ "s46072", "Trade_Survival", "=q2=Traveler's Tent", "=ds=#sr# =so1=50 =so2=100 =so3=110 =so4=120" },
		{ "s36774", "weak_healing_salve_1", "=q1=Weak Healing Salve", "=ds=#sr# =so1=50 =so2=70 =so3=80 =so4=90" },
		{ "s36785", "INV_Weapon_ShortBlade_01", "=q1=Makeshift Knife", "=ds=#sr# =so1=60 =so2=80 =so3=90 =so4=100" },
		{ "s36786", "INV_Gauntlets_21", "=q2=Gardening Gloves", "=ds=#sr# =so1=65 =so2=85 =so3=95 =so4=105" },
		{ "s36787", "INV_Fishingpole_02", "=q1=Crude Fishing Rod", "=ds=#sr# =so1=70 =so2=90 =so3=100 =so4=110" },
		{ "s46074", "Trade_Herbalism", "=q2=Simple Wooden Planter", "=ds=#sr# =so1=75 =so2=100 =so3=112 =so4=125" },
	},
	SurvivalJourneyman1 = {
		{ "s36788", "INV_Spear_05", "=q1=Hunting Spear", "=ds=#sr# =so1=90 =so2=110 =so3=120 =so4=130" },
		{ "s36789", "INV_Misc_Flute_01", "=q2=Gardening Broom", "=ds=#sr# =so1=95 =so2=115 =so3=125 =so4=135" },
		{ "s36843", "INV_Misc_MonsterTail_03", "=q2=Simple Fishing Lure", "=ds=#sr# =so1=100 =so2=120 =so3=130 =so4=140" },
		{ "s36844", "healing_salve_1", "=q1=Healing Salve", "=ds=#sr# =so1=100 =so2=120 =so3=130 =so4=140" },
		{ "s36842", "INV_Weapon_Bow_07", "=q2=Oakwood Bow", "=ds=#sr# =so1=100 =so2=120 =so3=130 =so4=140" },
		{ "s36845", "INV_Misc_Bag_10_Red", "=q1=Fishing Bag", "=ds=#sr# =so1=105 =so2=125 =so3=135 =so4=145" },
		{ "s36846", "skinners_pack_1", "=q1=Skinner's Pack", "=ds=#sr# =so1=110 =so2=130 =so3=140 =so4=150" },
		{ "s46073", "INV_TradeskillItem_02", "=q2=Fishing Boat", "=ds=#sr# =so1=115 =so2=135 =so3=145 =so4=155" },
		{ "s36847", "INV_Spear_04", "=q1=Gardening Pitchfork", "=ds=#sr# =so1=120 =so2=140 =so3=150 =so4=160" },
		{ "s30071", "blackmouth_fishing_trap_1", "=q1=Blackmouth Fishing Trap", "=ds=#sr# =so1=125 =so2=145 =so3=155 =so4=165" },
		{ "s36848", "INV_Chest_Chain_10", "=q2=Murloc Scale Coat", "=ds=#sr# =so1=125 =so2=145 =so3=155 =so4=165" },
		{ "s36849", "bundle_of_oak_sticks_", "=q1=Bundle of Bright Wood Sticks", "=ds=#sr# =so1=125 =so2=135 =so3=140 =so4=145" },
		{ "s46066", "INV_Boots_Fabric_01", "=q2=Murloc's Flippers", "=ds=#sr# =so1=125 =so2=145 =so3=155 =so4=165" },
		{ "s36853", "INV_Sword_06", "=q2=Sturdy Blade", "=ds=#sr# =so1=130 =so2=150 =so3=160 =so4=170" },
		{ "s36850", "INV_Misc_Net_01", "=q1=Sturdy Net", "=ds=#sr# =so1=130 =so2=130 =so3=135 =so4=140" },
		{ "s36851", "INV_Staff_17", "=q1=Sturdy Cane", "=ds=#sr# =so1=130 =so2=150 =so3=160 =so4=170" },
		{ "s36852", "INV_Weapon_ShortBlade_04", "=q2=Sturdy Knife", "=ds=#sr# =so1=130 =so2=150 =so3=160 =so4=170" },
		{ "s36854", "INV_Fishingpole_02", "=q1=Reliable Fishing Rod", "=ds=#sr# =so1=135 =so2=155 =so3=165 =so4=175" },
		{ "s36855", "INV_Misc_Net_01", "=q1=Throwable Net", "=ds=#sr# =so1=140 =so2=160 =so3=170 =so4=180" },
		{ "s36856", "hat_of_the_junior_chef_1", "=q3=Hat of the Junior Chef", "=ds=#sr# =so1=140 =so2=160 =so3=170 =so4=180" },
		{ "s30073", "INV_Misc_Bag_10", "=q2=Rugged Mining Sack", "=ds=#sr# =so1=140 =so2=160 =so3=170 =so4=180" },
		{ "s36858", "INV_Ammo_Arrow_02", "=q2=Bright Wood Arrows", "=ds=#sr# =so1=145 =so2=165 =so3=175 =so4=185" },
		{ "s36857", "INV_Misc_PocketWatch_02", "=q2=Treasure Compass", "=ds=#sr# =so1=145 =so2=165 =so3=175 =so4=185" },
		{ "s36861", "inv_misc_food_85", "=q2=Spicy Fishing Lure", "=ds=#sr# =so1=150 =so2=170 =so3=180 =so4=190" },
		{ "s36860", "potent_healing_salve_1", "=q1=Potent Healing Salve", "=ds=#sr# =so1=150 =so2=170 =so3=180 =so4=190" },
		{ "s36859", "INV_Misc_Bag_11", "=q1=Studded Rations Bag", "=ds=#sr# =so1=150 =so2=170 =so3=180 =so4=190" },
	},
	SurvivalExpert1 = {
		{ "s30004", "slowing_bolas_2", "=q1=Slowing Bolas", "=ds=#sr# =so1=155 =so2=175 =so3=185 =so4=195" },
		{ "s46075", "INV_Misc_Lantern_01", "=q2=Iron Lantern", "=ds=#sr# =so1=160 =so2=180 =so3=190 =so4=200" },
		{ "s30078", "snap_trap_3", "=q1=Snap Trap", "=ds=#sr# =so1=160 =so2=180 =so3=190 =so4=200" },
		{ "s30006", "INV_Sword_16", "=q1=Edged Machete", "=ds=#sr# =so1=165 =so2=185 =so3=195 =so4=205" },
		{ "s30008", "INV_Spear_05", "=q1=Iron Spear", "=ds=#sr# =so1=165 =so2=185 =so3=195 =so4=205" },
		{ "s30010", "INV_Fishingpole_02", "=q1=Reinforced Fishing Rod", "=ds=#sr# =so1=170 =so2=190 =so3=200 =so4=210" },
		{ "s30015", "bundle_of_pine_sticks_", "=q1=Bundle of Shade Wood Sticks", "=ds=#sr# =so1=175 =so2=185 =so3=190 =so4=195" },
		{ "s30084", "firefin_fishing_trap_1", "=q1=Firefin Fishing Trap", "=ds=#sr# =so1=175 =so2=195 =so3=205 =so4=215" },
		{ "s30013", "INV_Boots_07", "=q3=Water Trudgers", "=ds=#sr# =so1=175 =so2=195 =so3=205 =so4=215" },
		{ "s46068", "INV_Misc_Bandage_07", "=q1=Cleaning Cloth", "=ds=#sr# =so1=180 =so2=200 =so3=210 =so4=220" },
		{ "s30017", "spirited_precision_sickle_2", "=q2=Sharpened Herb Sickle", "=ds=#sr# =so1=180 =so2=200 =so3=210 =so4=220" },
		{ "s30022", "INV_Misc_Cape_06", "=q2=Lined Wintercloak", "=ds=#sr# =so1=185 =so2=205 =so3=215 =so4=225" },
		{ "s30024", "INV_Weapon_Bow_02", "=q2=Sleek Pinewood Bow", "=ds=#sr# =so1=190 =so2=210 =so3=220 =so4=230" },
		{ "s36747", "INV_Potion_122", "=q1=Jungle Remedy", "=ds=#sr# =so1=195 =so2=215 =so3=225 =so4=235" },
		{ "s30027", "superior_healing_salve_1", "=q1=Superior Healing Salve", "=ds=#sr# =so1=200 =so2=220 =so3=230 =so4=240" },
		{ "s30029", "INV_Misc_Pelt_Wolf_Ruin_03", "=q2=Savory Fishing Lure", "=ds=#sr# =so1=200 =so2=220 =so3=230 =so4=240" },
		{ "s36796", "INV_Ammo_Arrow_02", "=q2=Shade Wood Arrows", "=ds=#sr# =so1=205 =so2=225 =so3=235 =so4=245" },
		{ "s36795", "nutritious_rations_2", "=q1=Nutritious Rations", "=ds=#sr# =so1=205 =so2=225 =so3=235 =so4=245" },
		{ "s36798", "INV_Staff_07", "=q1=Hiking Staff", "=ds=#sr# =so1=215 =so2=235 =so3=245 =so4=255" },
		{ "s36797", "INV_Axe_24", "=q2=Vine Cutter", "=ds=#sr# =so1=215 =so2=235 =so3=245 =so4=255" },
		{ "s36799", "INV_ThrowingAxe_01", "=q1=Tree Hatchet", "=ds=#sr# =so1=215 =so2=235 =so3=245 =so4=255" },
		{ "s36800", "bundle_of_tropical_sticks_1", "=q1=Bundle of Tropical Sticks", "=ds=#sr# =so1=225 =so2=235 =so3=240 =so4=245" },
	},
	SurvivalArtisan1 = {
		{ "s46077", "INV_Misc_Lantern_01", "=q3=Repaired Electro-Lantern", "=ds=#sr# =so1=230 =so2=250 =so3=260 =so4=270" },
		{ "s36801", "INV_Helmet_31", "=q2=Sunshade Hat", "=ds=#sr# =so1=235 =so2=255 =so3=265 =so4=275" },
		{ "s36802", "INV_Misc_Bag_19", "=q2=Thick Rations Bag", "=ds=#sr# =so1=235 =so2=255 =so3=265 =so4=275" },
		{ "s36805", "aromatic_berries_2", "=q1=Aromatic Berries", "=ds=#sr# =so1=240 =so2=260 =so3=270 =so4=280" },
		{ "s36804", "spiced_berries_2", "=q1=Spiced Berries", "=ds=#sr# =so1=240 =so2=260 =so3=270 =so4=280" },
		{ "s36803", "INV_Weapon_Bow_07", "=q2=Warped Recurve Bow", "=ds=#sr# =so1=240 =so2=260 =so3=270 =so4=280" },
		{ "s36806", "advanced_camouflage_2", "=q1=Advanced Camouflage", "=ds=#sr# =so1=245 =so2=265 =so3=275 =so4=285" },
		{ "s36807", "inv_parachute_9", "=q1=Emergency Parachute", "=ds=#sr# =so1=250 =so2=270 =so3=280 =so4=290" },
		{ "s36809", "INV_Misc_EngGizmos_19", "=q2=Premium Fishing Lure", "=ds=#sr# =so1=250 =so2=270 =so3=280 =so4=290" },
		{ "s36808", "stabilizing_healing_salve_1", "=q1=Stabilizing Healing Salve", "=ds=#sr# =so1=250 =so2=270 =so3=280 =so4=290" },
		{ "s30031", "INV_Ammo_Arrow_02", "=q2=Smooth Ironfeather Arrows", "=ds=#sr# =so1=255 =so2=275 =so3=285 =so4=295" },
		{ "s30033", "INV_Sword_33", "=q1=Heavy Duty Machete", "=ds=#sr# =so1=260 =so2=280 =so3=285 =so4=290" },
		{ "s30035", "INV_Sword_33", "=q2=Thorium Edged Machete", "=ds=#sr# =so1=260 =so2=280 =so3=285 =so4=290" },
		{ "s30037", "INV_Spear_08", "=q1=Thorium Spear", "=ds=#sr# =so1=265 =so2=285 =so3=295 =so4=305" },
		{ "s30039", "INV_Weapon_ShortBlade_14", "=q3=Razor-sharp Skinning Knife", "=ds=#sr# =so1=270 =so2=290 =so3=300 =so4=310" },
		{ "s30042", "bundle_of_star_wood_sticks_1", "=q1=Bundle of Star Wood Sticks", "=ds=#sr# =so1=270 =so2=275 =so3=280 =so4=285" },
		{ "s30086", "stonescale_fishing_trap_1", "=q1=Stonescale Fishing Trap", "=ds=#sr# =so1=275 =so2=295 =so3=305 =so4=315" },
		{ "s30045", "INV_Fishingpole_02", "=q3=Mastercraft Fishing Rod", "=ds=#sr# =so1=275 =so2=295 =so3=305 =so4=315" },
		{ "s30050", "miners_rucksack_1", "=q2=Miner's Rucksack", "=ds=#sr# =so1=280 =so2=300 =so3=310 =so4=320" },
		{ "s30065", "fishermans_backpack_1", "=q2=Fisherman's Backpack", "=ds=#sr# =so1=285 =so2=305 =so3=315 =so4=325" },
		{ "s30052", "herbalists_knapsack_1", "=q2=Herbalist's Knapsack", "=ds=#sr# =so1=285 =so2=305 =so3=315 =so4=325" },
		{ "s30054", "skinners_pack_1", "=q2=Skinner's Carryall", "=ds=#sr# =so1=285 =so2=305 =so3=315 =so4=325" },
		{ "s30057", "INV_Misc_Bag_17", "=q3=Cooling Rations Bag", "=ds=#sr# =so1=290 =so2=310 =so3=320 =so4=330" },
		{ "s30069", "oil-powered_cooker_4", "=q3=Oil-Powered Cooker", "=ds=#sr# =so1=295 =so2=315 =so3=325 =so4=335" },
		{ "s36749", "spirited_precision_sickle_4", "=q3=Spirited Precision Sickle", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		{ "s30067", "INV_Ammo_Arrow_02", "=q3=Starfeather Arrows", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		{ "s30063", "major_healing_salve_1", "=q1=Major Healing Salve", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		{ "s36751", "prospectors_magnifying_lens_3", "=q3=Prospector’s Magnifying Lens", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
	},
	...
	JewelcraftingJourneyman2 = {
		...
		{ "s34758", "INV_Jewelry_Necklace_13", "=q3=Kodoheart Necklace", "=ds=#sr# =so1=125 =so2=145 =so3=160 =so4=175" },
