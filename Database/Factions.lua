AtlasLoot_Data["AtlasLootRepItems"] = {
	...
	Thorium2 = {
		...
		{ 50750, "INV_Scroll_06", "=q1=Outline: Prospector's Magnifying Lens", "#p16# (300)" },
	...
	Zandalar1 = {
		...
		{ 50749, "INV_Scroll_06", "=q1=Outline: Spirited Precision Sickle", "#p16# (300)" },
	...
	Helf = {
		...
		{ 0, "", "", "" },
		{ 0, "race_high_elf", "=q6=Leather Armor", "" },
		...
		{ 0, "", "", "" },
		{ 0, "race_high_elf", "=q6=Plate Armor", "" },
	...
	Dalaran = {
		...
		{ 0, "", "", "" },
		{ 0, "Spell_Holy_MagicalSentry", "=q6=#r5#", "" },
	...
	DraeneiExiles = {
		{ 0, "INV_Enchant_ShardGlowingLarge", "=q6=#r2#" },
		{ 33177, "INV_Misc_Root_02", "=q2=Draenic Ritual Drums", "#s14#" },
		{ 33178, "INV_Misc_Cape_16", "=q2=Crystalwoven Drape", "#s4#" },
		{ 33137, "INV_Chest_Chain_05", "=q2=Narak'la Padded Breastplate", "#s5#, #a3#" },
		{ 33136, "INV_Helmet_30", "=q2=Wraps of the Rift Traveler", "#s1#, #a1#" },
		{ 0, "", "", "" },
		{ 0, "INV_Enchant_ShardGlowingLarge", "=q6=#r3#" },
		{ 33139, "INV_Sword_39", "=q3=Draenethyst Blade", "#h1#, #w10#" },
		{ 33138, "INV_Sword_10", "=q3=Draenethyst Kris", "#h1#, #w4#" },
		{ 33140, "INV_Hammer_02", "=q3=Draenethyst Juggernaut", "#h2#, #w6#" },
		{ 33143, "inv_archaeology_70_highborne_inertleystonecharm", "=q3=Draenethyst Necklace", "#s2#" },
		{ 33141, "INV_Weapon_Bow_09", "=q3=Draenethyst Longbow", "#w2#, #w2#" },
		{ 33142, "INV_Misc_Orb_03", "=q3=Draenethyst Scepter", "#s15#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "INV_Enchant_ShardGlowingLarge", "=q6=#r4#" },
		{ 37072, "INV_Misc_Orb_02", "=q1=Palatinate Pebble", "#e15#" },
		{ 37071, "INV_Drink_19", "=q1=Toothy", "#e15#" },
		{ 33144, "INV_Misc_Note_01", "=q3=Formula: Rift Tear", "#p4# (300)" },
		{ 33145, "INV_Scroll_05", "=q3=Schematic: Facetted Crystal Scope", "#p5# (300)" },
		{ 0, "", "", "" },
		{ 0, "INV_Enchant_ShardGlowingLarge", "=q6=#r5#" },
		{ 30005, "Ability_Hunter_Pet_Crocolisk", "=q3=Swamp Riding Crocolisk", "#e7#" },
		{ 33148, "INV_Wand_06", "=q4=Alar'tar, Born from Hope", "#h2#, #w9#" },
		{ 33147, "INV_Jewelry_Talisman_08", "=q4=Mar'kali, the Midnight Star", "#s14#" },
	},
	EarthenRing = {
		{ 0, "Spell_Nature_EarthShock", "=q6=#r2#" },
		{ 33124, "INV_Bracer_13", "=q3=Warden's Bracers", "#s8#, #a1#" },
		{ 33123, "INV_Jewelry_Ring_AhnQiraj_05", "=q3=Loop of Shattered Earth", "#s13#" },
		{ 0, "", "", "" },
		{ 0, "Spell_Nature_EarthShock", "=q6=#r4#" },
		{ 33129, "INV_Misc_Cape_20", "=q3=Drape of the Far Seer", "#s4#" },
		{ 33127, "INV_Gauntlets_06", "=q3=Wraps of the Spirit Guide", "#s9#, #a1#" },
		{ 33128, "INV_Helmet_04", "=q3=Wolfsong's Cowl", "#s1#, #a2#" },
		{ 33125, "INV_Belt_30", "=q3=Clasp of Molten Rage", "#s10#, #a4#" },
		{ 33126, "inv_misc_desecrated_mailchest", "=q3=Cyclone Hauberk", "#s5#, #a3#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "Spell_Nature_EarthShock", "=q6=#r5#" },
		{ 33133, "INV_Shirt_GuildTabard_01", "=q1=Earthen Ring Tabard", "#s7#" },
		{ 33132, "Spell_Nature_StoneSkinTotem", "=q4=Totem of Calm Cascades", "#s16#, #e17# =q15=#c7#" },
		{ 33131, "INV_Boots_Chain_06", "=q4=Ragefury Stompers", "#s12#, #a3#" },
